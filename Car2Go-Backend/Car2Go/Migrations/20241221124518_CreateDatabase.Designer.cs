...
namespace Car2Go.Migrations
{
    ...
    [Migration("20241221124518_CreateDatabase")]
            ...
            modelBuilder.Entity("Car2Go.Models.Car", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CarId = 1,
                            AvailableDate = new DateOnly(2024, 12, 21),
                        ...
                        {
                            CarId = 2,
                            AvailableDate = new DateOnly(2024, 12, 22),
                            AvailableStatus = true,
                            Colour = "Red",
                            CreatedById = 3,
                        ...
                        {
                            CarId = 3,
                            AvailableDate = new DateOnly(2024, 12, 23),
                            AvailableStatus = true,
                            Colour = "Black",
                            CreatedById = 3,
