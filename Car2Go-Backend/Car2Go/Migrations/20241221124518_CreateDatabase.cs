...
namespace Car2Go.Migrations
{
    ...
    public partial class CreateDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Cars",
                columns: new[] { "CarId", "AvailableDate", "AvailableStatus", "Colour", "CreatedById", "ImageUrl", "LicensePlate", "LocationId", "Make", "Model", "PricePerDay", "TotalSeats", "year" },
                values: new object[,]
                {
                    { 1, new DateOnly(2024, 12, 21), true, "White", 3, "https://res.cloudinary.com/dhnatfkvb/image/upload/v1733810275/oyqzglkehqgbutmggfas.jpg", "MP09CP7235", 2, "Honda", "Honda City", 3000m, 5, 2020 },
                    { 2, new DateOnly(2024, 12, 22), true, "Red", 3, "https://res.cloudinary.com/dhnatfkvb/image/upload/v1733810445/honda-amaze-2018-red_vruzbl.jpg", "MH50PS2184", 1, "Honda", "Honda Amaze", 3200m, 5, 2018 },
                    { 3, new DateOnly(2024, 12, 23), true, "Black", 3, "http://res.cloudinary.com/dhnatfkvb/image/upload/v1733813312/o6xkah1rdvc4lytcydhp.webp", "MP09DY9472", 3, "Maruti Suzuki ", " Maruti Suzuki Swift", 2000m, 5, 2021 }
                });
